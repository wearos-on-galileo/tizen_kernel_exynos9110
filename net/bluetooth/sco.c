...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] sk: 0x%p, remote: %02X-%02X", __FUNCTION__, __LINE__, sk, sa->sco_bdaddr.b[1], sa->sco_bdaddr.b[0]);
#else
...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] sk: 0x%p, backlog: %d", __FUNCTION__, __LINE__, sk, backlog);
#else
...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] sk: 0x%p, timeo: %ld", __FUNCTION__, __LINE__, sk, timeo);
#else
...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] new sk: 0x%p", __FUNCTION__, __LINE__, ch);
#else
...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] sock: 0x%p, sk: 0x%p", __FUNCTION__, __LINE__, sock, sk);
#else
	BT_DBG("sock %p, sk %p", sock, sk);
#endif
...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] sk: 0x%p", __FUNCTION__, __LINE__, sk);
#else
	BT_DBG("sock %p, sk %p", sock, sk);
#endif
...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] hcon: 0x%p, remote: %02X-%02X, status: 0x%02x", __FUNCTION__, __LINE__, hcon, hcon->dst.b[1], hcon->dst.b[0], status);
#else
...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[%s(%d)] hcon: 0x%p, remote: %02X-%02X, reason: 0x%02x", __FUNCTION__, __LINE__, hcon, hcon->dst.b[1], hcon->dst.b[0], reason);
#else
