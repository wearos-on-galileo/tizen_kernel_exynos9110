...
/*
 * Define for detecting opt/usr emmcblk
 */
#if defined(CONFIG_GALILEO)
#if defined(CONFIG_GALILEO_LTE)
#define EXT4_OPT_USR_BLOCK_NUMBER_1	'1'
#define EXT4_OPT_USR_BLOCK_NUMBER_2	'9'
#else
#define EXT4_OPT_USR_BLOCK_NUMBER_1	'1'
#define EXT4_OPT_USR_BLOCK_NUMBER_2	'7'
#endif
#define EXT4_SUPER_BLOCK_ID_NUMBER_1	8
#define EXT4_SUPER_BLOCK_ID_NUMBER_2	9
#endif
