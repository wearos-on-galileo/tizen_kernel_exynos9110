...
#ifndef __LINUX_MFD_SEC_RTC_S2MP_H
#define __LINUX_MFD_SEC_RTC_S2MP_H
...
#define CV_DROP_LEVEL_SHIFT		2
#define CV_DROP_LEVEL_WIDTH		2
#define CV_DROP_LEVEL_MASK	MASK(CV_DROP_LEVEL_WIDTH, CV_DROP_LEVEL_SHIFT)

/* S2MP_RTC_REG_CTRL [6:4] bit is indicator bit.
 * Galileo project use these bit as FG dynamic sacling factor repository
 */
#define FG_DYNAMIC_SCALE_SHIFT			4
#define FG_DYNAMIC_SCALE_MASK			(7 << FG_DYNAMIC_SCALE_SHIFT)
...
#endif
#endif /*  __LINUX_MFD_SEC_RTC_S2MP_H */
